...
[![Version](https://img.shields.io/badge/version-1.3.1-blue.svg)](https://marketplace.visualstudio.com/items?itemName=holooooo.markdown-kanban)
...
```bash
# Clone repository
git clone https://github.com/holooooo/markdown-kanban.git
cd markdown-kanban
...
1. **Fork the repository**
   ```bash
   gh repo fork holooooo/markdown-kanban
   ```
...
Found a bug? Please [open an issue](https://github.com/holooooo/markdown-kanban/issues/new) with:
...
- **Issues**: [GitHub Issues](https://github.com/holooooo/markdown-kanban/issues)
- **Discussions**: [GitHub Discussions](https://github.com/holooooo/markdown-kanban/discussions)
- **Marketplace**: [VSCode Marketplace](https://marketplace.visualstudio.com/items?itemName=holooooo.markdown-kanban)
...
- Special thanks to all [contributors](https://github.com/holooooo/markdown-kanban/graphs/contributors)

---

## 📊 Project Stats

![GitHub stars](https://img.shields.io/github/stars/holooooo/markdown-kanban?style=social)
![GitHub forks](https://img.shields.io/github/forks/holooooo/markdown-kanban?style=social)
![GitHub issues](https://img.shields.io/github/issues/holooooo/markdown-kanban)
![GitHub pull requests](https://img.shields.io/github/issues-pr/holooooo/markdown-kanban)
